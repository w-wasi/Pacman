...
APacmanPawn* AEnemyPawn::GetPacmanPawn()
{
	auto Pawn = GetWorld()->GetFirstPlayerController()->GetPawn();
	return Cast<APacmanPawn>(Pawn);
}
...
void AEnemyPawn::BeginPlay()
{
	...
	GetPacmanPawn()->OnPacmanPowerUp.AddUniqueDynamic(this, &AEnemyPawn::OnPacmanSuperState);
	GetPacmanPawn()->OnPacmanDeath.AddUniqueDynamic(this, &AEnemyPawn::OnPacmanDeadState);
 ...
 void AEnemyPawn::SetCurrEscapeRoute()
{
 ...
 {
	 SetCurrentState(EEnemyStatus::Vulnerable);
	 SetCurrEscapeRoute2(); //escape route1 is below
 }
